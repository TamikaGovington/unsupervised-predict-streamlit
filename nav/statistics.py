...
# load data
movies = pd.read_csv('https://raw.githubusercontent.com/Makhambi/movies-data/main/movies.csv')
imdb = pd.read_csv('https://raw.githubusercontent.com/Makhambi/movies-data/main/imdb_data.csv')
...
def visuals():
        ...
        st.write("You can explore some interesting stats about the movies.")
        
        with st.expander("Movie insights"):
                st.write("### Movies from 1900-2022")
                ...
                kpi3.metric(label = "Avg rating",
                        value = 3.54 )
                st.info('Select 2 or more option to plot 1 or more movie statistics')
